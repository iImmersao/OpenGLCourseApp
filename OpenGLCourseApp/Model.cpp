...
void Model::RenderModel() {
	...
	//for (size_t i = 0; i < meshLimit; i++) {
		unsigned int materialIndex = meshToTex[i];
		//printf("Mesh %d maps to texture %d\n", i, materialIndex);
...
void Model::LoadMesh(aiMesh* mesh, const aiScene* scene) {
	...
	for (size_t i = 0; i < mesh->mNumVertices; i++) {
		...
		// Normals are reversed (negated), because the fragment shader is using positive normals in the colour creation; the call to normalize there is often negated.
